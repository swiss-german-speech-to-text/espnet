...
rsync -a $HOME/espnet/egs2/swiss_german/asr_baseline2/dump $TMPDIR/
rsync -a $HOME/espnet/egs2/swiss_german/asr_baseline2/exp $TMPDIR/

./run.sh

rsync -au $TMPDIR/dump $HOME/espnet/egs2/swiss_german/asr_baseline2/
rsync -au $TMPDIR/exp $HOME/espnet/egs2/swiss_german/asr_baseline2/
...
rsync -a $HOME/espnet/egs2/swiss_german/asr_baseline2/dump $TMPDIR/dump
rsync -a $HOME/espnet/egs2/swiss_german/asr_baseline2/exp $TMPDIR/exp

./run.sh

rsync -au $TMPDIR/dump $HOME/espnet/egs2/swiss_german/asr_baseline2/dump
rsync -au $TMPDIR/exp $HOME/espnet/egs2/swiss_german/asr_baseline2/exp
...
#SBATCH -o scicore_out/%A_%a_rnn.out
#SBATCH -e scicore_out/%A_%a_rnn.err
#SBATCH --gres=gpu:4
...
rsync -a $HOME/espnet/egs2/swiss_german/asr_baseline2/dump_transformer $TMPDIR/
rsync -a $HOME/espnet/egs2/swiss_german/asr_baseline2/exp_transformer $TMPDIR/

./run.sh

rsync -au $TMPDIR/dump_transformer $HOME/espnet/egs2/swiss_german/asr_baseline2/
rsync -au $TMPDIR/exp_transformer $HOME/espnet/egs2/swiss_german/asr_baseline2/
...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
    ...
    if [ -d "$DIR" ]; then
      ...
      mkdir $DIR
      local/data_prep.pl downloads/stt/kanton_ar_kantonsrat/v1 "train_all" data/kanton_ar_kantonsrat/teacher_labels
    ...
    if [ -d "$DIR" ]; then
      ...
      mkdir $DIR
      local/data_prep.pl downloads/stt/kanton_ow_kantonsrat/v1 "train_all" data/kanton_ow_kantonsrat/teacher_labels
    ...
    if [ -d "$DIR" ]; then
      ...
      mkdir $DIR
      local/data_prep.pl downloads/stt/stadt_bern_stadtrat_alligned "train" data/stadt_bern_stadtrat/teacher_labels
